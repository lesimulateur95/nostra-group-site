...
const games = [
  ...
  { key: "hi_lo", label: "Hi-Lo", kicker: "PLUS HAUT OU PLUS BAS", symbol: "↕", text: "Devine la valeur de la prochaine carte, enchaîne les bonnes réponses et encaisse avant l’erreur.", meta: ["Solo", "Cartes", "Encaissement libre"] },
  { key: "skyscraper", label: "Gratte-ciel", kicker: "MONTE OU ENCAISSE", symbol: "▥", text: "Choisis une porte à chaque étage et grimpe vers le sommet sans tomber sur l’étage perdant.", meta: ["Solo", "8 étages", "Risque progressif"] },
  { key: "memory", label: "Memory Casino", kicker: "MÉMOIRE SOUS PRESSION", symbol: "◫", text: "Retrouve les six paires avant d’épuiser tes tentatives. Moins tu joues de coups, plus le gain augmente.", meta: ["Solo", "Mémoire", "Tentatives limitées"] },
