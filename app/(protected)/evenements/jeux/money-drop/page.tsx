...
function errorLabel(value: string | undefined) {
  ...
  if (decoded.includes("not_player")) return "Seuls les membres de l’équipe sélectionnée peuvent répartir la cagnotte.";
  if (decoded.includes("allocations_total")) return "Toute la cagnotte doit être placée sur les trappes avant validation.";
  if (decoded.includes("timer_expired")) return "Le chronomètre est terminé. La régie doit maintenant verrouiller les mises.";
  if (decoded.includes("question_closed")) return "La répartition est actuellement fermée par la régie.";
  ...
  if (decoded.includes("joker_unavailable")) return "Ce joker sera disponible pendant la phase de répartition.";
