...
export default async function CircuitDisciplineDashboardPage({
  searchParams,
}: {
  ...
  return (
    <main className={styles.page}>
      ...
      <header className={styles.hero}>
        <div>
          <span>NOSTRA CIRCUIT · DIRECTION</span>
      ...
      <section className={styles.panel}>
        <div className={styles.panelHeading}>
          <div>
            ...
            <h2>Historique complet de la Direction</h2>
          </div>
          <p>Les 300 dernières opérations sont conservées.</p>
        </div>
