export const GAMES_SETUP_SQL = String.raw`-- Nostra Group V29.4 — Roue de la chance, un tirage par jour
...
begin
  ...
  begin
    insert into public.game_wheel_spins (user_id, player_name, slot_index, prize_key, prize_label, prize_type, redemption_status, draw_date)
    values (v_user_id, v_player_name, v_slot, v_prize_key, v_prize_label, v_prize_type, v_status, v_draw_date)
