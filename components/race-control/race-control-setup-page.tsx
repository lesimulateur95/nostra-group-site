...
export type RaceControlSetupSearchParams = {
  error?: string;
  reset?: string;
  deleted?: string;
};
...
export async function RaceControlSetupPageContent({
  searchParams,
  basePath,
  backPath,
  backLabel,
  ...
  backPath: "/dashboard" | "/commissaires";
  backLabel: string;
}) {
    ...
    <main className="dashboard-stack">
      <header className="dashboard-page-header">
        <div>
          ...
          <p>
            Prépare la grille de départ, lance tous les chronomètres et
            enregistre chaque passage sur la ligne.
          </p>
        </div>

        <Link className="btn btn-secondary" href={backPath}>
          ← {backLabel}
        </Link>
      </header>
      ...
      {!configured && (
        <section className="dashboard-setup">
          <span className="module-status">Activation V37 nécessaire</span>
      ...
      {configured && (
        <>
          <RaceEventSetup basePath={basePath} />
          ...
          <section className={styles.resetPanel}>
            <div>
              ...
              <p>
                La réinitialisation retire les courses concernées des
                résultats publics et remet les points à zéro. Les courses, les
                tours et tous les chronos restent enregistrés dans la base de
                données.
              </p>
            </div>
            ...
            >
              ...
              <label className={styles.resetConfirm}>
                ...
                />
                <span>
                  Je confirme la remise à zéro des résultats publiés
                  sélectionnés.
                </span>
              </label>
          ...
          <section className="backoffice-panel">
            <div className="panel-heading">
              ...
              <div>
                ...
                <p>
                  Retrouve les courses en préparation, en direct et déjà
                  publiées.
                </p>
              </div>
            </div>
            ...
            <p className={styles.savedRaceWarning}>
              Le bouton rouge supprime définitivement la course, ses pilotes,
              ses tours et ses chronos. Aucune fenêtre de confirmation ne
              s’ouvrira.
            </p>
            ...
            <div className={styles.savedRaceList}>
              ...
              {state.events.map((event) => (
                <article className={styles.savedRaceRow} key={event.id}>
                  <Link
                  ...
                  >
                    ...
                    <span className="dashboard-card-content">
                      ...
                      <small>
                        ...
                        {event.target_laps} tour(s) · {event.participant_count}{" "}
                        pilote(s)
                      </small>
                      <small>
                  ...
                  <form action={deleteRaceControlEvent}>
                    ...
                    <button className={styles.deleteRaceButton} type="submit">
                      Supprimer la course
                    </button>
                  </form>
                </article>
