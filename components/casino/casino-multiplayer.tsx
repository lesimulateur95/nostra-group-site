...
function CitizenPokerTable({ room, pending, act }: { room: PvpRoom; pending: boolean; act: (body: Record<string, unknown>, success: string) => void }) {
